<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="user_detail.aspx.cs" Inherits="admin_user_detail" %>
...
<FooterStyle BackColor="White" Font-Names="Arial" ForeColor="#333333" />
 ...
 <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" DeleteCommand="DELETE FROM [tbl_user] WHERE [userid] = @userid" InsertCommand="INSERT INTO [tbl_user] ([name], [email], [phoneno], [password]) VALUES (@name, @email, @phoneno, @password)" SelectCommand="SELECT [userid], [name], [email], [phoneno], [password] FROM [tbl_user]" UpdateCommand="UPDATE [tbl_user] SET [name] = @name, [email] = @email, [phoneno] = @phoneno, [password] = @password WHERE [userid] = @userid" ID="SqlDataSource1"><DeleteParameters>
