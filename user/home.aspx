			...
			<div class="inner-text">
			 ...
			 <%--<form action="#">
				<h3>Choose Your Best Car</h3>
					<div class="best-hot">
						<h5>Name</h5>
						<input type="text"  placeholder="Name" required="" class="frm-field required">
					</div>
					<div class="best-hot">
						<h5>Email</h5>
                        	<input type="text"  placeholder="Email" required="" class="frm-field required">
					</div>
							 ...
							 <div class="news-updates">
                                 ...
                                 <ItemTemplate>
                                 	<div class="update-info-w3l">
										...
										<h4><a href="news_single.aspx?nid=1">
											...
											<a href="news_single.aspx?nid=4" class="read hvr-shutter-in-horizontal">
