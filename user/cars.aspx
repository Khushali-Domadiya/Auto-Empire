							...
							<div class="row list-group" id="products">
                                ...
                                <div class="item  col-xs-4 col-lg-4">
									<div class="thumbnail">
                                             ...
                                             <asp:Image ID="img" runat="server" alt="AUTO EMPIRE" ImageUrl='<%# "~/admin/model_img/" + Eval("image") %>'  style=" display: block;max-width: 397.5px; max-height :297.7px; height: 100%; width: auto;" />
                                                                </a>
